        ...
        <div>
            ...
            <main>
                ...
                {portfolioData?.lastAnalysis && new Date(portfolioData.lastAnalysis) < new Date(Date.now() - 24*60*60*1000) && (
                    <h2>Portfolio analysis is more than 24 hours old. Consider re-uploading your CSV file for an updated analysis.</h2>
                    
                )}
                {portfolioData?.lastAnalysis && new Date(portfolioData.lastAnalysis) < new Date(Date.now() - 24*60*60*1000) && (<FileUploader className="fileUploader" onUploadSuccess={portfolioFetch} />)}
